...
//------------------------------------------------------------------------------------
	...
	public void addPackage(InsurancePackage insp) {
		...
		jdbcTemplate.update(stmt, insp.getInspTitle(), insp.getInspDescription(), insp.getInspStatus(), insp.getInspRangeStart(), insp.getInspRangeEnd(), insp.getInspAgeLimitStart(), insp.getInspAgeLimitEnd());
	}
}
